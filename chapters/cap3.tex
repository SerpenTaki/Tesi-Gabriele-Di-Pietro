...
void main() {
  ...
  //nome = null; //Errore null non può essere assegnato a String
...
\subsubsection{\textit{Stateful} e \textit{stateless widget}}

\subsection{Architettura a tre livelli}
(descrivo la composizione di questa architettura)

\subsubsection{Il \textit{design pattern provider}}
