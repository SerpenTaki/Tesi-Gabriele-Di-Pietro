...
progettate ex novo in base alle opportunità e alle esigenze del mercato. In tale contesto, la società si distingue per la sua
...
di un \textit{system integrator}, rappresenta uno dei principali punti di forza dell'azienda che è in grado di offrire soluzioni complete e personalizzate.
\newline
...
\begin{itemize}
    ...
    \item \textbf{Firebase}: un \textit{database} sviluppato da Google e ben integrato con Flutter che offre una serie di funzionalità di \textit{backend} pronte all'uso per la propria applicazione.
        \begin{itemize}
            ...
            \item \textbf{Firestore}: \textit{database} \textit{NoSQL} orientato ai documenti, che permette di archiviare i documenti in raccolte, dove queste ultime fungono da contenitori
...
\begin{itemize}
    ...
    \item \textbf{GitHub Projects}: una sezione di GitHub dedicata alla gestione dei \textit{ticket}, preferita in alternativa a \textbf{Trello} normalemente utilizzato dall'azienda. Questo strumento consente di creare \textit{roadmap} e schede integrate con le \textit{issue} dei \textit{repository}, facilitando la pianificazione e il monitoraggio delle attività sia a livello individuale che di \textit{team}.
\end{itemize}
