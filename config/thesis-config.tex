...
\makeatletter
% Avoid error if \listing/\listing* are already defined by another package:
% If \listing undefined, declare 'listing', otherwise declare 'listingx' and
% provide \listlistingname so other code can use it.
\@ifundefined{listing}{
    \DeclareCaptionType{listing}[Codice Sorgente][Lista degli elementi di codice]
}{
    \DeclareCaptionType{listingx}[Codice Sorgente][Lista degli elementi di codice]
}
\providecommand{\listlistingname}{Lista degli elementi di codice}
\makeatother

\renewcommand{\listlistingname}{Lista degli elementi di codice}
...
\renewcommand{\listfigurename}{Lista degli elementi di codice}
